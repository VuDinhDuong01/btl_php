...
<body>
    <h2 class='pt-3 px-3'>Quản lý thư mục</h2>
            ...
            ?>
                <tbody>
                    <tr>
                        ...
                        <td class="text-center align-middle"><a href='quantri.php?page_layout=suadm&id_dm=<?= $id ?>' class='active'><button type="button" class="btn btn-success">Sửa</button></a></td>
                        <td class="text-center align-middle"> <a href="quantri.php?page_layout=xoadm&id=<?= $id ?>" onclick='return confirm("bạn có muốn xóa thư mục này không!")'><button type="button" class="btn btn-danger">Xóa</button></a></td>
                    </tr>
