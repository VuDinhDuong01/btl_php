...
<body>
    <div style="margin-left:20px;margin-top:50px">
        <div class="" style="font-size:15px">
            <p class="" style="font-size:20px">Quý khách đã đặt hàng thành công!</p>
        ...
        <p id="return-home" align="right"><a href="khachhang.php" style="color:red">Quay về trang chủ</a></p>
    </div>
</body>
